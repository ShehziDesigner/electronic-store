...
export interface ApiDiscountBannerDiscountBanner
  extends Struct.CollectionTypeSchema {
  collectionName: 'discount_banners';
  info: {
    displayName: 'DiscountBanner';
    pluralName: 'discount-banners';
    singularName: 'discount-banner';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::discount-banner.discount-banner'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::discount-banner.discount-banner': ApiDiscountBannerDiscountBanner;
